...
либо docker-compose up -d (предаврительнов в settings.py закомментировав 'HOST': '127.0.0.1' и раскомментировав  'HOST': '172.20.0.100',) и сервре запустится  по адресу http://0.0.0.0:8000/  
